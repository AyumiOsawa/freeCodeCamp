// PERFROM A SUBSET CHECK ON TWO SETS OF DATA
//
...
// will compare the first set against the second, and if the first set is fully
// contained within the second, it will return true.
//
// For example, if setA = ['a','b'] and setB = ['a','b','c','d'], then setA is
// a subset of setB, so setA.isSubsetOf(setB) should return true.
//
...
class Set {
  ...
  isSubsetOf(set) {
    return this.values().every(element => set.has(element));
  };
